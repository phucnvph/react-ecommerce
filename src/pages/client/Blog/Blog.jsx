const Blog = () => {
    return (
        <>
            <div>
                <section className="bg-img1 txt-center p-lr-15 p-tb-92" style={{ backgroundImage: 'url("./dist/client/images/bg-02.jpg")' }}>
                                ...
                                <div className="p-r-45 p-r-0-lg">
                                    <div className="p-b-63">
                                        <a href="blog-detail.html" className="hov-img0 how-pos5-parent">
                                            <img src="./dist/client/images/blog-04.jpg" alt="IMG-BLOG" />
                                    ...
                                    <div className="p-b-63">
                                        <a href="blog-detail.html" className="hov-img0 how-pos5-parent">
                                            <img src="./dist/client/images/blog-05.jpg" alt="IMG-BLOG" />
                                            <div className="flex-col-c-m size-123 bg9 how-pos5">
                                                <span className="ltext-107 cl2 txt-center">
                                                    18
                                                </span>
                                    ...
                                    <div className="p-b-63">
                                        <a href="blog-detail.html" className="hov-img0 how-pos5-parent">
                                            <img src="./dist/client/images/blog-06.jpg" alt="IMG-BLOG" />
                                            <div className="flex-col-c-m size-123 bg9 how-pos5">
                                                <span className="ltext-107 cl2 txt-center">
                                                    16
                                                </span>
                                        ...
                                        <ul>
                                            <li className="flex-w flex-t p-b-30">
                                                <a href="#" className="wrao-pic-w size-214 hov-ovelay1 m-r-20">
                                                    <img src="./dist/client/images/product-min-01.jpg" alt="PRODUCT" />
                                                </a>
                                            ...
                                            <li className="flex-w flex-t p-b-30">
                                                <a href="#" className="wrao-pic-w size-214 hov-ovelay1 m-r-20">
                                                    <img src="./dist/client/images/product-min-02.jpg" alt="PRODUCT" />
                                                </a>
                                                <div className="size-215 flex-col-t p-t-8">
                                                    <a href="#" className="stext-116 cl8 hov-cl1 trans-04">
                                            ...
                                            <li className="flex-w flex-t p-b-30">
                                                <a href="#" className="wrao-pic-w size-214 hov-ovelay1 m-r-20">
                                                    <img src="./dist/client/images/product-min-03.jpg" alt="PRODUCT" />
                                                </a>
                                                <div className="size-215 flex-col-t p-t-8">
                                                    <a href="#" className="stext-116 cl8 hov-cl1 trans-04">
