const Contact = () => {
    return (
        <>
            <div>
                <section className="bg-img1 txt-center p-lr-15 p-tb-92" style={{ backgroundImage: 'url("./dist/client/images/bg-01.jpg")' }}>
                            ...
                            <div className="size-210 bor10 p-lr-70 p-t-55 p-b-70 p-lr-15-lg w-full-md">
                                <form>
                                    ...
                                    <div className="bor8 m-b-20 how-pos4-parent">
                                        ...
                                        <img className="how-pos4 pointer-none" src="./dist/client/images/icons/icon-email.png" alt="ICON" />
                                    </div>
                ...
                <div className="map">
                    <div className="size-303" id="google_map" data-map-x="40.691446" data-map-y="-73.886787" data-pin="./dist/client/images/icons/pin.png" data-scrollwhell={0} data-draggable={1} data-zoom={11} />
                </div>
            </div>
